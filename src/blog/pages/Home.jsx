                 ...
                 <div className="section">
                     ...
                     <div className="container">
                             ...
                             <div className="col-md-6">
                                 <div className="post post-thumb">
                                     ...
                                     <div className="post-body">
                                         ...
                                         <h3 className="post-title"><a href="blog-post.html">Ask HN: Does Anybody Still
                                                 Use JQuery?</a></h3>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <div className="row">
                             ...
                             <div className="col-md-4">
                                 <div className="post">
                                     ...
                                     <div className="post-body">
                                         ...
                                         <h3 className="post-title"><a href="blog-post.html">Pagedraw UI Builder Turns
                                                 Your Website Design Mockup Into Code Automatically</a></h3>
                                     </div>
                                 </div>
                             </div>
                             {/* /post */}
                             ...
                             <div className="col-md-4">
                                 <div className="post">
                                     <a className="post-img" href="blog-post.html"><img src="./storage/static/post-6.jpg"
                                             alt="" /></a>
                                     <div className="post-body">
                                         <div className="post-meta">
                                             <a className="post-category cat-2" href="category.html">JavaScript</a>
                                         ...
                                         <h3 className="post-title"><a href="blog-post.html">Why Node.js Is The Coolest
                             ...
                             <div className="col-md-4">
                                 <div className="post">
                                     ...
                                     <div className="post-body">
                                         ...
                                         <h3 className="post-title"><a href="blog-post.html">CSS Float: A Tutorial</a>
                                         </h3>
                                     </div>
                                 </div>
                             </div>
                             ...
                             <div className="col-md-4">
                                 <div className="post">
                                     ...
                                     <div className="post-body">
                                         ...
                                         <h3 className="post-title"><a href="blog-post.html">Tell-A-Tool: Guide To Web
